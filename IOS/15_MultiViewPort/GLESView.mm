...
-(id)initWithFrame:(CGRect)frame;
{
	...
	if(self)
	{
        ...
        // *** vertices, colors, shader attribs, vbo, vao intiallize ****
...
-(void)drawView:(id)sender
{
    ...
    if (status == 0)
     ...
     glViewport(currentWidth / 2, 0, (GLsizei)currentWidth / 2, (GLsizei)currentHeight / 2);
     else if (status == 3)
     glViewport(0, currentHeight / 2, (GLsizei)currentWidth / 2, (GLsizei)currentHeight / 2);
     else if (status == 4)
     glViewport(currentWidth / 2, currentHeight / 2, (GLsizei)currentWidth / 2, (GLsizei)currentHeight / 2);
     else if (status == 5)
     glViewport(0, 0, (GLsizei)currentWidth / 2, (GLsizei)currentHeight);
     else if (status == 6)
     glViewport(currentWidth / 2, 0, (GLsizei)currentWidth / 2, (GLsizei)currentHeight);
     else if (status == 7)
     glViewport(0, currentHeight / 2, (GLsizei)currentWidth, (GLsizei)currentHeight / 2);
     else if (status == 8)
     glViewport(0, 0, (GLsizei)currentWidth, (GLsizei)currentHeight / 2);
     else if (status == 9)
     glViewport(currentWidth / 4, currentHeight / 4, (GLsizei)currentWidth / 2, (GLsizei)currentHeight / 2);
