...
float MaterialAmbient[4];// = { 0.0,0.0,0.0,1.0 };
...
void update(void)
{
	...
	firstRotation = 100 * cos(LightAngle);
	secondRotation = 100 * sin(LightAngle);
...
void draw24Sphere() {
	...
	constantBuffer.MaterialShinyness = Material_Shinyness;
	 ...
	 wvMatrix = translationMatrix;// *worldMatrix;// *viewMatrix;//* gPerspectiveProjectionMatrix;
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = 0;
	d3dViewPort.Width = (float)gwidth/6;
	d3dViewPort.Height = (float)gheight/6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = (1 * gheight) / 6;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = (2 * gheight) / 6;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = (3 * gheight) / 6;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = (4 * gheight) / 6;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = 0;
	d3dViewPort.TopLeftY = (5 * gheight) / 6;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = (1 * gwidth) / 4;
	d3dViewPort.TopLeftY = 0;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = (2 * gwidth) / 4;
	d3dViewPort.TopLeftY = 0;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
	...
	d3dViewPort.TopLeftX = (3 * gwidth) / 4;
	d3dViewPort.TopLeftY = 0;
	d3dViewPort.Width = (float)gwidth / 6;
	d3dViewPort.Height = (float)gheight / 6;
	gpID3D11DeviceContext_BRK->RSSetViewports(1, &d3dViewPort);
