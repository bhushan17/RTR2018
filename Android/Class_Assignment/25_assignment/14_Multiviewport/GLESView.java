package com.matrix_android.Multiviewport;
...
public class GLESView extends GLSurfaceView implements  OnGestureListener, OnDoubleTapListener,  GLSurfaceView.Renderer
{
	...
	private void resize(int width,int height)
	{
		...
		if (status == 0)
			...
			GLES32.glViewport(0, 0, width / 2, height / 2);
		else if (status == 2)
			GLES32.glViewport(width / 2, 0, width / 2, height / 2);
		else if (status == 3)
			GLES32.glViewport(0, height / 2, width / 2, height / 2);
		else if (status == 4)
			GLES32.glViewport(width / 2, height / 2, width / 2, height / 2);
		else if (status == 5)
			GLES32.glViewport(0, 0, width / 2, height);
		else if (status == 6)
			GLES32.glViewport(width / 2, 0, width / 2, height);
		else if (status == 7)
			GLES32.glViewport(0, height / 2, width, height / 2);
		else if (status == 8)
			GLES32.glViewport(0, 0, width, height / 2);
		else if (status == 9)
			GLES32.glViewport(width / 4, height / 4, width / 2, height / 2);
