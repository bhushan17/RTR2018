package com.matrix_android.RoboticArm;
...
public class GLESView extends GLSurfaceView implements  OnGestureListener, OnDoubleTapListener,  GLSurfaceView.Renderer
{
	...
	float lightDiffuse[] = { 0.5f, 0.35f, 0.05f,1.0f };
	...
	private float sholder = 0.0f;
	private float  elbo = 0.0f;
	private boolean bLight = false;
	private boolean elboanimation = true;
	...
	private void display()
	{
		...
		Matrix.setRotateM(rotationMatrix,0,elbo, 0.0f, 0.0f,1.0f);
		Matrix.multiplyMM(modelMatrix,0,modelMatrix,0,rotationMatrix,0);
