package com.matrix_android.Pyramid_and_cube_with_texture;
...
public class GLESView extends GLSurfaceView implements  OnGestureListener, OnDoubleTapListener,  GLSurfaceView.Renderer
{
	...
	private void intialize()
	{
		...
		//Create and bind vbo_texture_cube
		...
		textureCube[0]=loadTexture(R.raw.kundali);
	...
	private void display()
	{
		...
		GLES32.glActiveTexture(GLES32.GL_TEXTURE0);
		GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, textureCube[0]);
		GLES32.glUniform1i(samplerUniform, 0);
