package com.matrix_android.TwoLights_ON_RotatingPyramid;
...
public class GLESView extends GLSurfaceView implements  OnGestureListener, OnDoubleTapListener,  GLSurfaceView.Renderer
{
	...
	float RedlightPosition[] = { -2.0f,0.0f,-3.0f,1.0f };
	...
	float BluelightPosition[] = { 2.0f,0.0f,-3.0f,1.0f };
	...
	private void intialize()
	{
		...
		float pyramidVertices[] = { 0.0f, 1.0f, 0.0f,
										-1.0f, -1.0f, 1.0f,
										1.0f, -1.0f, 1.0f,
		...
		float pyramidNormals[] = { 0.0f, 0.447214f, 0.894427f,
	...
	private void update()
	{
		if (animation == true)
		{
			if (PyramidAngle > 360)
			{
				...
				PyramidAngle = PyramidAngle + 0.5f;
	...
	private void display()
	{
		...
		Matrix.setRotateM(rotationMatrix,0,PyramidAngle, 0.0f, 1.0f, 0.0f);
