package com.matrix_android.orthographic_projection;
...
public class GLESView extends GLSurfaceView implements  OnGestureListener, OnDoubleTapListener,  GLSurfaceView.Renderer
{
	...
	private void resize(int width,int height)
	{
		...
		if (width < height)
		{
		Matrix.orthoM(orthoGraphicProjectionMatrix,0,-100.0f, 100.0f, -100.0f * (float)(height / width), 100.0f *(float)(height / width), -100.0f, 100.0f);
		}
		else {
			Matrix.orthoM(orthoGraphicProjectionMatrix,0,-100.0f*(float)(width / height), 100.0f, -100.0f * (float)(width/height), 100.0f , -100.0f, 100.0f);
		}
	}
