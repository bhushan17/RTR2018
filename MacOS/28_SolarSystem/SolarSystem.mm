...
-(void)drawView
{
    ...
    vmath::mat4 pushMatrix3 = vmath::mat4::identity();
    ...
    if (bLight_BRK == TRUE)
    {
		...
		glUniform3f(ld_Uniform_BRK, 1.0f, 0.5f, 0.05f); // White color
		...
		glUniform3f(kd_Uniform_BRK, 0.5f, 0.5f, 0.5f); // material property gray
	...
	rotationMatrix = vmath::rotate(year, 0.0f, 1.0f, 0.0f);
	...
	pushMatrix3 = modelMatrix;
	
	rotationMatrix = vmath::rotate(90.0f, 1.0f, 0.0f, 0.0f);
	rotationMatrix = vmath::rotate(day, 0.0f, 1.0f, 0.0f);
    ...
    if (bLight_BRK == TRUE)
    {
        glUniform1i(LKeyPress_Uniform_BRK, 1);
		glUniform3fv(la_Uniform_BRK, 1 , lightAmbient );
		glUniform3f(ld_Uniform_BRK, 0.1f, 0.1f, 0.8f); // White color
		//glUniform3fv(ld_Uniform_BRK, 1, lightDiffuse);
		glUniform3fv(ls_Uniform_BRK, 1, lightSpecular);
		glUniform4fv(lightPosition_Uniform_BRK, 1, lightPosition);
	...
	glBindVertexArray(0);
	 ...
	 modelMatrix = pushMatrix3;
	 
	rotationMatrix = vmath::rotate(moon, 0.0f, 0.0f, 1.0f);
	translateMatrix = vmath::translate(1.0f, 0.0f, 0.0f);
	rotationMatrix = vmath::rotate(90.0f, 0.0f, 1.0f, 0.0f);
	rotationMatrix = vmath::rotate(moonself, 0.0f, 1.0f, 0.0f);
    ...
    if (bLight_BRK == TRUE)
    {
        glUniform1i(LKeyPress_Uniform_BRK, 1);
		glUniform3fv(la_Uniform_BRK, 1 , lightAmbient );
		glUniform3f(ld_Uniform_BRK, 0.7f, 0.7f, 0.7f); // White color
		//glUniform3fv(ld_Uniform_BRK, 1, lightDiffuse);
		glUniform3fv(ls_Uniform_BRK, 1, lightSpecular);
		glUniform4fv(lightPosition_Uniform_BRK, 1, lightPosition);
