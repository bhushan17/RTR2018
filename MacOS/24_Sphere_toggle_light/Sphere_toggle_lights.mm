...
-(void)prepareOpenGL
{
   ...
   "out vec4 fragColor;" \
    ...
    modelMatrix_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_model_matrix");
	viewMatrix_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_view_matrix");
	projection_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_projection_matrix");

	la_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_la");
	ld_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_ld");
	ls_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_ls");
	lightPosition_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_lightPosition");

	ka_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_ka");
	kd_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_kd");
	ks_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_ks");
	materialShinyness_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_materialShinyness");
	LKeyPress_Uniform_BRK = glGetUniformLocation(shaderProgramObject_PF_BRK, "u_Lkeypress");
...
-(void)dealloc
{
	...
	glDetachShader(shaderProgramObject_PF_BRK, vertexShaderObject_PF_BRK);
	//detach fragment shader from shader program object
	glDetachShader(shaderProgramObject_PF_BRK, fragmentShaderObject_PF_BRK);
	
	//delete vertex shader object
	glDeleteShader(vertexShaderObject_PF_BRK);
	vertexShaderObject_PF_BRK = 0;
	//delete fragment shader object
	glDeleteShader(fragmentShaderObject_PF_BRK);
	fragmentShaderObject_PF_BRK = 0;
	
	//delete shader program object
	glDeleteProgram(shaderProgramObject_PF_BRK);
	shaderProgramObject_PF_BRK = 0;
