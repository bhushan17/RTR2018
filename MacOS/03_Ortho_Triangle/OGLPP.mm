...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	[window setTitle:@"macOS OpenGL Bhushan's Window"];
	[window center];
...
@private
	...
	vmath::mat4 orthographicProjectioMatrix;
}
...
-(void)prepareOpenGL
{
	...
	orthographicProjectioMatrix = vmath::mat4::identity();
...
-(void)reshape
{
	...
	if(width<=height)
		orthographicProjectioMatrix=vmath::ortho(-100.0f,100.0f,(-100.0f * (height / width)),(100.0f * (height/width)),100.0f,100.0f);
	else
		orthographicProjectioMatrix=vmath::ortho((-100.0f * (width/height)),(100.0f * (width/height)),-100.0f ,100.0f,-100.0f,100.0f);
...
-(void)drawView
{
	...
	modelViewProjectionMatrix = orthographicProjectioMatrix * modelViewMatrix; // ORDER IS Important
