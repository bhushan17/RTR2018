...
void display(void){
	...
	//code
	static float triangle_rotation_angle = 0.0f;
	static float rectangle_rotation_angle = -360.0f;
	...
	glRotatef(rectangle_rotation_angle, 1.0f, 0.0f, 0.0f);
	...
	{
		rectangle_rotation_angle = -360.0f;
		triangle_rotation_angle = 0.0f;
	}
	else {
		rectangle_rotation_angle = rectangle_rotation_angle + 0.005f;
		triangle_rotation_angle = triangle_rotation_angle + 0.005f;
	}
