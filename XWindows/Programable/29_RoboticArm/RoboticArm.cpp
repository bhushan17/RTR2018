...
float lightDiffuse[4] = { 0.5f,0.35f,0.0f,1.0f };
...
void display(void){
	...
	rotationMatrix = rotate(sholder, 0.0f, 0.0f,1.0f);
	...
	*/
	...
	translateMatrix = translate(2.0f, 0.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * translateMatrix;
	rotationMatrix = rotate(elbo, 0.0f, 0.0f, 1.0f);
	modelViewMatrix = modelViewMatrix * rotationMatrix;
