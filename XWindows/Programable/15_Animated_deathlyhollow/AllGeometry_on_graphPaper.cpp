...
void display(void){
	...
	if (triangletranslate < 0.7f) {
		triangletranslate = triangletranslate + 0.00004f;
	}
	...
	if (trianglestatus == 1)
	{
		if (circletranslate < 0.7f) {
			circletranslate = circletranslate + 0.00004f;
	...
	if (circlestatus) {
		...
		if (linetranslate < 1.0f) {
			linetranslate = linetranslate + 0.00005f;
			lineycoordinate = lineycoordinate - 0.00005f;
		}
		else {
			linetranslate = 1.0f;
