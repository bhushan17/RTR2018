...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wparam, LPARAM lParam)
{
	...
	ptr = "Song.wav";
	ptr1 = "Bekhayali_Kabir_Singh.wav";
	size_t var;
	...
	case WM_CHAR:
		...
		case 'n':
			...
			if (newtrav != NULL)
			{
				...
				//wsprintf(str, TEXT("Filename = %d"), var);
				//MessageBox(hwnd, str, L"Filename", MB_OK);
				//soundflag = true;
				...
				MessageBox(hwnd, TEXT("This is last song in the list."), TEXT("Bhushan Midia msg"), MB_OK);
			}
...
int intialize(void)
{
	...
	//ptr3 = trav->filename;
	//ptr4 = trav->next->filename;
	//SoundEngine->play2D(trav->filename, GL_TRUE);
	//SoundEngine->play2D(ptr4, GL_TRUE);
	soundflag = true;
	
	//wsprintf(str, TEXT(" filename = %s"), trav->filename);
	//MessageBox(NULL, str, TEXT("Filename "), MB_OK);
