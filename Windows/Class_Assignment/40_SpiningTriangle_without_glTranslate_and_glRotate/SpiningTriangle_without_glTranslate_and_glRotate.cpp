...
void display()
{
	...
	rotation_matrix[0] = cos(triangle_rotation_angle);
	rotation_matrix[1] = 0.0f;
	rotation_matrix[2] = -sin(triangle_rotation_angle);
	rotation_matrix[3] = 0.0f;
	rotation_matrix[4] = 0.0f;
	rotation_matrix[5] = 1.0f;
	rotation_matrix[6] = 0.0f;
	rotation_matrix[7] = 0.0f;
	rotation_matrix[8] = sin(triangle_rotation_angle);
	rotation_matrix[9] = 0.0f;
	rotation_matrix[10] = cos(triangle_rotation_angle);
	...
	if (triangle_rotation_angle > 360)
	{
		...
		triangle_rotation_angle = triangle_rotation_angle + 0.05f;
	}
