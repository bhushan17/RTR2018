...
void display()
{
	...
	int index, numpoints = 1000, outer_index;
	float radius = 0.1f;
	float co_ordinate = 0.0f;
	...
	{
		glLineWidth(2.0f);
		glColor3f(colorArray[outer_index][0], colorArray[outer_index][1], colorArray[outer_index][2]);
		glBegin(GL_LINE_LOOP);
		
		glVertex3f(0.0f, 1.0f - co_ordinate, 0.0f);

		glVertex3f(-1.0f + co_ordinate, -1.0f + co_ordinate, 0.0f);
