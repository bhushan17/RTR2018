...
float moon = 0;
float moonself = 0;
GLUquadric *quadricsun = NULL, *quadricearth = NULL, *quadricmoon = NULL;
...
void display()
{
	...
	glRotatef(90.0f, 1.0f, 0.0f, 0.0f);
	glRotatef(GLfloat(moonself), 0.0f, 0.0f, 1.0f);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	quadricmoon = gluNewQuadric();
	glColor3f(0.4f, 0.4f, 0.4f);
	gluSphere(quadricmoon, 0.05f, 10, 10);
