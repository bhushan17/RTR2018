...
void ToggelFullScreen(void)
{
	...
	else
	{
		...
		iCenteringWindowX = ((rc.right - rc.left) / 2) - ((wpPrev.rcNormalPosition.right - wpPrev.rcNormalPosition.left) / 2);
		iCenteringWindowY = ((rc.bottom - rc.top) / 2) - ((wpPrev.rcNormalPosition.bottom - wpPrev.rcNormalPosition.top) / 2);
		SetWindowLong(ghWnd, GWL_STYLE, dwStyle | WS_OVERLAPPEDWINDOW);
