...
void ToggelFullScreen(void)
{
	...
	else
	{
		...
		iCenteringWindowX = ((mI.rcMonitor.right - mI.rcMonitor.left) / 2) - ((wpPrev.rcNormalPosition.right - wpPrev.rcNormalPosition.left) / 2);
		iCenteringWindowY = ((mI.rcMonitor.bottom - mI.rcMonitor.top) / 2) - ((wpPrev.rcNormalPosition.bottom - wpPrev.rcNormalPosition.top) / 2);
		SetWindowLong(ghWnd, GWL_STYLE, dwStyle | WS_OVERLAPPEDWINDOW);
