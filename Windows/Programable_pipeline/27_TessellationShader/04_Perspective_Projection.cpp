...
int intialize(void)
{
	...
	const GLchar *tessellationEvaluationShaderSorceCode =
		"#version 450 core" \
		"\n" \
		"layout(isolines)in;" \
	...
	glShaderSource(gTessellationEvaluationShaderObject, 1, (const GLchar**)&tessellationEvaluationShaderSorceCode, NULL);
	...
	//Attach TessellationControlShaderObject Shader to the Shader Program
	glAttachShader(glShaderProgramObject, gTessellationControlShaderObject);

	//Attach TessellationEvaluationShaderObject Shader to the Shader Program
	glAttachShader(glShaderProgramObject, gTessellationEvaluationShaderObject);
	...
	//get number of segments uniform loaction
	gNumberOfSegmentsUniform = glGetUniformLocation(glShaderProgramObject, "numberOfSegments");

	//get number of strips uniform loaction
	gNumberOfStripsUniform = glGetUniformLocation(glShaderProgramObject, "numberOfStrips");

	//get line color uniform loaction
	gLineColorUniform = glGetUniformLocation(glShaderProgramObject, "lineColor");
...
void display()
{
	...
	modelViewMatrix = translate(0.5f, -0.5f, -5.0f);
	...
	TCHAR str[255];
	wsprintf(str, TEXT("OpenGL Prograble Pipeline Window : [Segments = %d]"), gNumberofLineSegments);
