...
int intialize(void)
{
	...
	glAttachShader(glShaderProgramObject, gGeometryShaderObject);
	...
	// ********* Vertices **********
	const GLfloat trianglevertices[] = { 0.0f, 1.0f, 0.0f,1.0f,0.0f,0.0f,
	...
	glVertexAttribPointer(AMC_ATTRIBUTE_POSITION, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), 0);
	...
	glVertexAttribPointer(AMC_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3 * sizeof(float)));
