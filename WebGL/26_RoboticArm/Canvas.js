...
var light_diffuse=[0.5, 0.35, 0.05];
...
function draw()
{
	...
	FirstmodelMatrix = modelMatrix;
	mat4.rotateZ(modelMatrix,modelMatrix,degToRad(sholder));
	...
	mat4.rotateZ(modelMatrix,modelMatrix,degToRad(elbo));
